...
export default function AdminPlayers() {
  ...
  const sortedGlobalPlayers = [...globalPlayers].sort((firstPlayer, secondPlayer) => firstPlayer.name.localeCompare(secondPlayer.name));
